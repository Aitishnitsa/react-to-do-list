  ...
  (
    ...
    return (
      <div ref={ref} {...droppableProps} className="sm:w-1/3 p-2 mx-2">
        <h1
          className={`${titleColor} text-black dark:text-black animate-jump-in w-full rounded-full py-1 flex justify-center font-bold relative z-10`}
        >
          {title}
        </h1>
        {children}
        {addingMode && (
          <form
            ...
            className="border-2 border-black dark:border-white rounded-md w-full py-1 px-2 my-2"
          >
            <input
              value={newTaskText}
