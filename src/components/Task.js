...
const Task = ({ id, text, isDragging }) => {
    const { deleteTask } = useContext(TasksContext);
    const [isShown, setIsShown] = useState(false)

    return (
        <div
            className={`${isDragging ? "bg-gray-200" : "bg-white"} hover:bg-gray-50 transition ease-in-out duration-150 border-2 border-black rounded-md w-full py-1 px-2 my-2 flex justify-between items-center group`}
        ...
        >
            ...
            {isShown &&
                <button onClick={() => {
                    ...
                    <svg className="fill-black opacity-25 hover:opacity-100" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
